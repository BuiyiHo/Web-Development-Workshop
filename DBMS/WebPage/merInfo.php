...
<?php
	$exist=false;
	$sql = "SELECT *FROM Merchant WHERE cid = $cid";
	...
	echo"<h5>Merchant's Name:$name</h5><h5>City:$city</h5><h5>Address:$address</h5>";	
?>
			</div>
		</div>
		<div class="links">
			...
			<div class="container">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="parallax-item">
						...
						<form method="POST" action="changeInfomer.php?action=changeName">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="parallax-item">
						...
						<form method="POST" action="changeInfomer.php?action=changePw">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="parallax-item">
						...
						<form method="POST" action="changeInfomer.php?action=deac">
							<input type="submit" ><br>
						</form>
						</a>
					</div>
